    ...
    <div style={{ marginBottom: '24px' }}>
      <div style={{ 
        ...
        {tokens.map((token) => (
          ...
          >
            <span style={{ fontSize: '1.1rem' }}>{token.logo}</span>
    ...
    <div style={{
      ...
      <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '2.5rem' }}>{selectedToken.logo}</div>
          <div style={{ flex: 1, minWidth: '200px' }}>
            <div style={{ 
              ...
              {tokenInfo?.name || selectedToken.name}
        ...
        <div style={{
          ...
          <StatCard 
            ...
            icon="👥"
            subValue="Top 100 by balance"
          />
          <StatCard 
            label="Top 10%" 
            value={top10PercentCount.toString()}
            icon="🐋"
            subValue="Whale wallets"
          />
          <StatCard 
            label="Recent Transfers" 
            value={transfers.length.toString()}
            icon="📊"
            subValue="Last 50 transactions"
          />
          <StatCard 
            label="Total Supply %" 
            value={
              holders.length > 0 
                ? formatNumber(holders.reduce((sum, h) => sum + parseFloat(h.percentage_relative_to_total_supply || 0), 0)) + '%'
                : '0%'
            }
            icon="📈"
            subValue="Held by top 100"
          />
        </div>
        ...
        <div style={{
          ...
          {['holders', 'transfers'].map(tab => (
            ...
            >
              {tab === 'holders' ? '🐋 Top Holders' : '📈 Transfers'}
            </button>
          ))}
        ...
        {error && (
          <div style={{
            ...
            <div style={{ fontSize: '0.85rem', color: '#999' }}>
              Check the token address and network, or try refreshing.
            </div>
          </div>
        )}
        ...
        {loading && holders.length === 0 && (
          <div style={{
            ...
            <div>Loading data for {selectedToken.symbol}...</div>
          </div>
        )}
