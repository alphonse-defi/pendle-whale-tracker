...
export default function App() {
  ...
  // Fetch transfers from Moralis (wallet-to-wallet movements)
  const fetchMoralisTransfers = useCallback(async () => {
    ...
    try {
      ...
      return transfersData.result.map(t => {
        ...
        return {
          ...
          trader_address: type === 'mint' ? t.to_address : t.from_address,
          amount,
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <td style={{ padding: '14px 16px' }}>
                                      {transfer.type === 'buy' || transfer.type === 'sell' ? (
                                      ...
                                      ) : transfer.type === 'transfer' && transfer.to_address ? (
                                        ...
                                        <span style={{ color: '#666', fontSize: '0.75rem' }}>
                                          {transfer.type === 'mint' ? 'Token Minted' : 
                                           transfer.type === 'burn' ? 'Token Burned' : '-'}
                                        </span>
                                      )}
                                    </td>
                                    <td style={{ padding: '14px 16px' }}>
