...
const HolderDistributionChart = ({ holders, tokenInfo }) => {
  ...
  const top50Total = holders.slice(0, 50).reduce((sum, h) => sum + parseFloat(h.percentage_relative_to_total_supply || 0), 0);
  const top100Total = holders.slice(0, 100).reduce((sum, h) => sum + parseFloat(h.percentage_relative_to_total_supply || 0), 0);
  ...
  const segments = [
    ...
    { label: 'Top 26-50', percent: top50Total - top25Total, color: '#00d4ff' },
    { label: 'Top 51-100', percent: top100Total - top50Total, color: '#10b981' },
